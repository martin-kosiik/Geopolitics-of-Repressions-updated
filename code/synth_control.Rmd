...
tibble(mspe_ratios, ethnicity = names(mspe_ratios)) %>% 
  ...
  labs(x = "MSPE ratio", title = "Ratios of pre to post-treatment period mean squared prediction error")
...
out <- gsynth(log_n ~ post_german + pop_total + clad_sim +urb_rate , data = min_by_q, parallel = FALSE, 
