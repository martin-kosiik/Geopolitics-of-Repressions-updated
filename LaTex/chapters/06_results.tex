...
Figure \ref{fig:sc_placebo_gaps_all} also shows that for some ethnic groups the pre-treatment gaps are large.
 ...
 As we explained in subsection \ref{subsec:sc_methodology}, the placebo synthetic controls  with with substantially  worse pre-treatment then the treated unit should not be 
