...
\input{tables/diff_table_trends.tex}
\newpage

\input{tables/diff_table_pred_adj.tex}
\newpage
...
\end{figure}
 ...
 \begin{figure}[H]
\centering
\caption{Map of Soviet Regions (Provinces and ASSR), 1926}
\includegraphics[width=\textwidth]{plots/final/border_buffer_map.pdf}
\begin{minipage}{0.92\textwidth}
\footnotesize
\emph{Notes:} The shaded area shows the 250 km border buffer. The source of the map is \citet{sablin_transcultural_2018}.  
\end{minipage}
\label{fig:map}
\end{figure}
...
\end{subfigure}
\label{fig:sc_mspe_ratios_by_borer_comp}
\begin{minipage}{0.92\textwidth}
\footnotesize
