...
One solution, albeit only partial, might be to use the date of process (trial)   to extrapolate the missing date of arrest where the trail date is available.
...
There are more than 100 different ethnicities in the Memorial data. However, for many of these ethnic groups
