...
\begin{figure}[h]
\centering
\includegraphics[width=\textwidth]{plots/effects/annual/point_range_robust_cr2_date_imp_full_years.pdf}
\caption{Estimates of coefficients $\beta_k$ on the interactions of $\text{German}_{i} \cdot \text{Year}_{t}^k$}
