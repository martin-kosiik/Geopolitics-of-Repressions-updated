...
min_by_year <- read_csv(here("data/min_arrests_by_year.csv"))
...
fmla_window <- as.formula(paste("log_n ~ german:hostility + german:pact + german:war + as.factor(YEAR) +
                         ethnicity + ethnicity: YEAR"))
...
ggsave(here::here("plots/did_effects_window.pdf"))
```
