...
\normalsize{
\noindent The Literature Review and Historical Background sections are in final stages. I will probably make only some minor changes to them.
I have recently obtained better and more complete data which means that I will rewrite the Data section and the results from Difference-in-differences and Synthetic control. Furthermore, I am working on imputation of missing date of arrest from date of process. }
\newpage
\pagenumbering{roman}
