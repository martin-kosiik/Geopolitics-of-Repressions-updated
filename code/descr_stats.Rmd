...
min_by_year %>% 
  ...
  arrange(ethnicity) %>% 
  kable("latex", booktabs = T, caption = "Descriptive Statistics of Arrests by Ethnicity, 1921-1960", linesep = "",
        col.names = c("Ethnicity", "Mean", "St.dev.", "Min", "Max", "Total", 
                      "Mean", "St.dev.", "Min", "Max", "Total"), format.args = list(big.mark = " "), digits = 0) %>% 
  add_header_above(c(" " = 1, "Only labeled data" = 5, "Labels + Ethnicity imputations" = 5)) %>% 
  kable_styling(font_size = 8, latex_options = c("hold_position")) %>%  
