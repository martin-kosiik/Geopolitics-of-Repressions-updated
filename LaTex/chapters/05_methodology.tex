...
The synthetic control method has been increasingly used in the literature to overcome this issue. The method estimates the treatment effect by constructing a synthetic version of the treated unit  based on matching of pre-treatment variables. Unlike difference-in-differences, it allows for the presence of certain time-varying unit-specific confounders which can be captured by a factor model.
